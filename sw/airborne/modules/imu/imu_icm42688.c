...
void imu_icm42688_init(void)
{
  ...
  // TODO: Make this field configurable from the airframe file and/or GCS
  imu_icm42688.gyro_odr = INVENSENSE3_GYRO_ODR_2KHZ;
  imu_icm42688.gyro_range = INVENSENSE3_GYRO_RANGE_500DPS;
  imu_icm42688.accel_odr = INVENSENSE3_ACCEL_ODR_2KHZ;
  imu_icm42688.accel_range = INVENSENSE3_ACCEL_RANGE_2G;
  
  // The AAF freq needs to be high enough to avoid group delay and low enough to minimise noise and clipping
  imu_icm42688.gyro_aaf = 977; // ~ODR/4
  imu_icm42688.accel_aaf = 213; // Fixed
